...
else:   print (f'Welcome to the app, {barva_start}{username}{barva_stop}\nWe have {barva_start}3{barva_stop} texts to be analyzed.', sep='')

print (oddelovac)

#vyber textu
cislo_vybraneho_textu = int(input ('Enter a number btw. 1 and 3 to select: '))
print (oddelovac)
